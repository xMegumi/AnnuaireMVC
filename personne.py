...
class Personne:
    ...
    def __init__(self, prenom : str, nom : str, 
        ...
        bio : str, est_decede: bool = False) -> None: 
        ...
        self.__bio = bio
        self.__est_decede: bool = est_decede
    ...
    def __eq__(self, other) -> bool:
        """
        Vérifie si deux personnes sont égales en se basant sur leurs prénoms, noms, dates de naissance et dates de décès.
        """
        return (
    ...
    def est_decede(self) -> bool:
        return self.__est_decede

    @est_decede.setter
    def est_decede(self, value: bool) -> None:
        self.__est_decede = value
    ...
    def buildFromJSon(d: dict):
        ...
        if mortSTR :
            ...
            dateMort = ''
        est_decede = bool(d['est_decede'])
        bio = d['bio'] 

        return Personne(prenom, nom, genre,dateNaissance,dateMort, bio, est_decede)
